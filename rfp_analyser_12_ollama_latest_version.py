...
OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "llama3")  # e.g., "llama3", "llama3:70b"
...
st.info("""
**📊 5-Level Decision Matrix:** 
🚀 Strongly-Go (90-100%) | ✅ Go (80-90%) | ⚠️ Conditional Go (70-80%) | 🔍 Evaluate Again (60-70%) | ❌ No-Go (0-60%)
""")
